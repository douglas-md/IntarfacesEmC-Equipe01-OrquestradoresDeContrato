...
{
    /// <summary>
    /// Implementação InMemory do Repository usando Dictionary.
    /// Sem I/O real - tudo em memória (volatile).
    /// Política de ID: delegada via Func (domínio fornece o ID).
    /// </summary>
        ...
        where TId : notnull
    {
        ...
        /// <summary>
        /// Construtor com injeção da função extratora de ID.
        /// </summary>
        /// <param name="getId">Função que extrai o ID da entidade</param>
